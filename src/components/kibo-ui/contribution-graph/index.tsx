  ...
  return (
    <rect
      className={cn(
        ...
        'data-[level="1"]:fill-sky-300/45 dark:data-[level="1"]:fill-sky-900',
        'data-[level="2"]:fill-sky-400/65 dark:data-[level="2"]:fill-sky-700',
        'data-[level="3"]:fill-sky-500/80 dark:data-[level="3"]:fill-sky-500',
        'data-[level="4"]:fill-sky-600 dark:data-[level="4"]:fill-sky-300',
        className,
      )}
      ...
      {...props}
    >
      <title>{`${activity.count} aktivitas pada ${formatActivityDate(activity.date)}`}</title>
    </rect>
  );
};
